		...
		provide: {
			createGradientCanvas: <T extends keyof ChartTypeRegistry = 'line'>(
				...
				return (context: ScriptableContext<T>): void | CanvasGradient => {
					...
					gradientBg.addColorStop(1, opacify(-0.1, color))
					gradientBg.addColorStop(0.8, opacify(-0.2, color))
					gradientBg.addColorStop(0.65, opacify(-0.3, color))
					gradientBg.addColorStop(0.55, opacify(-0.4, color))
